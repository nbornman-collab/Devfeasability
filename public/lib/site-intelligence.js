...
function synthesisDevScope(si) {
  ...
  return `<p class="t-synthesis" style="margin-bottom:14px">${potentialNarrative}</p><p class="t-synthesis">${bsaNarrative}</p>`;
}
...
function synthesisPlanning(si) {
  ...
  return `<p class="t-synthesis" style="margin-bottom:14px">${planNarrative}${caNote}${titleNote}</p>`;
}
...
function synthesisArchitecture(si) {
  ...
  return `<p class="t-synthesis" style="margin-bottom:14px">${massingNarrative}</p><p class="t-synthesis" style="margin-bottom:14px">${carbonNarrative}</p><p class="t-note">${progNote}</p>`;
}
