// Development Intelligence - Land between the railway arches (east of Rye Lane including railway arches)
...
const SITE_INTELLIGENCE = {
  ...
  site: "Land between the railway arches (east of Rye Lane including railway arches)",
  borough: 'Southwark',
  use: 'mixed',
  address: "Land between the railway arches (east of Rye Lane including railway arches)",
  plot_area_m2: 33619,
  existing_gea_m2: 142881,
  existing_floors: 5,
  ...
  factors: {
    sky: { label: 'Available Sky', score: 6.0, weight: 2.5, existing_m: 15.8, insight: "Land between the railway arches (east of Rye Lane including railway arches) - auto-generated. Verify existing height." },
